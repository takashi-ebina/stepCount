...
/**
 * <p>コマンドライン引数の値、オプションを簡易に解析するクラス
 * 
 * @since 1.0
 * @version 1.0
...
public class Arguments {
    ...
    /**
     * <p>スクリプトモードで利用する引数をオブジェクト化したクラスを返却するメソッド
     * 
