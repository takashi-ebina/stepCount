...
public class CommentPatternMatchFactory {
	...
	/**
	 * <p>
	 * 拡張子に対応するコメントパターンマッチオブジェクトを生成するメソッド
	 * 
	 * @param extension 拡張子
	...
	public static IfCommentPatternMatch create(final String extension) throws Exception {
		...
		try {
			commentPatternMatchObj = (IfCommentPatternMatch) Class.forName(className).getDeclaredConstructor().newInstance();
		} catch (Exception e) {
